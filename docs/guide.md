...
topbar token with a borderless, square-ended two-level depth gauge. The fixed-scale track sits
above the topbar centerline, while the lower row is one left-aligned phrase such
