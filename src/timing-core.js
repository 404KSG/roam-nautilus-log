...
const EXECUTION_COPY = Object.freeze({
  en: {
    ...
    createToday: {
      ...
      partial: 'Creation is not complete. Open the written plan to inspect it before continuing.',
      templateChanged: 'The template changed before writing. Check it and try again.',
      recordUnavailable: 'Creation safety record is unavailable. No template blocks were written.',
      ...
      dateChangedAfterCreate: 'The plan was saved on the original date. Check the new day before continuing.',
  ...
  zh: {
    ...
    createToday: {
      ...
      partial: '创建尚未完成。请先打开已写计划检查，再继续。',
      templateChanged: '写入前模板已变化。请检查模板后重试。',
      recordUnavailable: '无法保存创建安全记录，未写入模板内容。',
      ...
      dateChangedAfterCreate: '计划已保存在原目标日期，请重新检查新一天的计划。',
