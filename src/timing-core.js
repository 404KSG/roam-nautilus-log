...
const EXECUTION_COPY = Object.freeze({
  en: {
    ...
    createToday: {
      ...
      blocked: 'Today’s template cannot be copied safely. Open the template to review it.',
      incomplete: 'Creation incomplete',
      resumeUnavailable: 'There is no matching in-memory creation to continue. Check today’s plan before starting a new operation.',
      partial: 'Creation is incomplete. Written blocks are retained; inspect them before continuing.',
      templateBlocked: 'Review template', readError: 'Plan unavailable',
      viewTemplate: 'View template', inspectCreated: 'Inspect created blocks', continueCreation: 'Continue creation',
      verifiedBlocks: 'blocks verified', noReloadResume: 'Continuation is available only to the original in-memory operation after validation.',
      details: 'Today’s plan details', close: 'Close',
      templateChanged: 'The template changed before writing. Check it and try again.',
      recordUnavailable: 'The creation safety receipt could not be verified. Existing contents were retained.',
      ...
      retry: 'Check again',
      manual: 'Use ;; to insert',
      retryLocate: 'Open today\'s plan',
      apiUnavailable: 'Required Roam APIs are unavailable. Check again, or use ;; on the target Daily Note.',
      lockUnavailable: 'Safe cross-tab creation is unavailable here. Use ;; to insert Nautilus Log.',
      scopeUnavailable: 'The current graph could not be identified. Use ;; to insert Nautilus Log.',
      graphChanged: 'The graph changed. Check today’s plan again before creating.',
      dateChanged: 'The date changed before insertion. Check today’s plan again.',
      dateChangedAfterCreate: 'The date changed. Any written blocks remain on the original day; check the new day before continuing.',
      unconfirmed: 'The write is not yet confirmed. Retry to check it; no second block was added.',
      uidCollision: 'A block identifier is already in use. No existing content was changed.',
    },
  },
  zh: {
    ...
    createToday: {
      ...
      locate: '打开今日计划',
      checking: '正在检查今日计划',
      blocked: '今日模板无法安全复制。请打开模板查看。',
      incomplete: '创建未完成',
      resumeUnavailable: '当前图谱和日期没有可继续的原内存创建操作，请重新检查今日计划。',
      partial: '创建未完成。已写入的内容会保留，请先检查。',
      templateBlocked: '检查模板', readError: '计划读取失败',
      viewTemplate: '查看模板', inspectCreated: '检查已创建内容', continueCreation: '继续创建',
      verifiedBlocks: '个块已验证', noReloadResume: '仅原内存操作验证通过后可继续；重载后只能检查和打开。',
      details: '今日计划详情', close: '关闭',
      templateChanged: '写入前模板已变化。请检查模板后重试。',
      recordUnavailable: '无法验证创建安全记录，已有内容已保留。',
      ...
      manual: '请用 ;; 插入模板',
      retryLocate: '打开今日计划',
      apiUnavailable: '所需 Roam API 暂不可用。请重新检查，或在目标 Daily Note 上用 ;; 插入。',
      lockUnavailable: '当前环境不支持安全的跨标签创建。请使用 ;; 插入 Nautilus Log。',
      scopeUnavailable: '无法确认当前图谱。请使用 ;; 插入 Nautilus Log。',
      graphChanged: '图谱已切换，请重新检查今日计划后再创建。',
      dateChanged: '插入前日期已变化，请重新检查今日计划。',
      dateChangedAfterCreate: '日期已变化。已写内容保留在原目标日期；请检查新一天后继续。',
      unconfirmed: '写入尚未确认。请重试检查；没有追加第二个组件。',
      uidCollision: '组件标识已被占用，没有修改现有内容。',
    },
  },
});
